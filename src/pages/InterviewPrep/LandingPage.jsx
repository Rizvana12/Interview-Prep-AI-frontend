        ...
        <div className='container mx-auto px-4 pt-6 pb-50 relative z-10'>
          ...
          <header className='flex justify-between items-center mb-16'>
            ...
            {user ? (
              ...
              <button className='bg-linear-to-r from-primary to-[#e99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-black hover:text-white border border-white transition-colors cursor-pointer'
          ...
          <div className='flex flex-col md:flex-row items-center'>
            <div className='w-full md:w-1/2 pr-4 mb-8 md:mb-8'>
              ...
              <h1 className='text-5xl text-black font-medium mb-6 leading-tight'>
                ...
                <span className='text-transparent bg-clip-text bg-linear-to-r from-primary to-[#FCD760] animate-text-shine font-semibold'>AI-Powered</span>{" "}
                Learning
              </h1>
            </div>
            <div className='w-full md:w-1/2'>
              <p className='text-[17px] text-gray-900 mr-0 md:mr-20 mb-6'>
                Get role-specific question, expand answers when you need them,
                dive deeper into concepts, and organize everything your way.
                From prepration to mastery - your ultimate interview toolkit is here.
              </p>
